...
function FAQ() {
  ...
  return (
	...
	<div class="grid divide-y divide-neutral-200 max-w-3xl mx-auto mt-8 px-3 lg:px-10 dark:bg-blacky">
		<div class="py-5">
			<details class="group">
				<summary class="flex justify-between items-center text-blacky dark:text-ashy text-sm md:text-xl cursor-pointer list-none">
				...
				<p class="text-neutral-600 mt-3 text-ashey dark:text-ashey text-xs md:text-base group-open:animate-fadeIn">
		...
		<div class="py-5">
			<details class="group">
				...
				<p class="text-neutral-600 text-ashey dark:text-ashey text-xs md:text-base mt-3 group-open:animate-fadeIn">
...
<div>
		<p className='text-sm text-black lg:text-2xl pt-10 text-center dark:text-white'> Still got more questions? <span className='text-purple underline'>Chat us</span> </p>
		</div>
		</AnimatePresence>
    </div>
  )
