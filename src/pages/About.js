    ...
    <div>
      <Navbar />
        <div className=" bg-about-pattern lg:pl-5" >
            ...
            <p className='text-3xl font-semibold text-left lg:text-left pt-8 md:pl-10 md:pt-0 lg:text-6xl dark:text-blacky'>
            About us
						</p>
            <div>
            <p className='sm:text-lg md:pl-5 text-blacky md:text-xs lg:text-lg text-left lg:text-left dark:text-blacky'>
